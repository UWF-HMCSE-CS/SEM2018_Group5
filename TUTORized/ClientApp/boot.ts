...
const routes = [
    ...
    { path: '/chatAsStudent', component: require('./components/chatAsStudent/chatAsStudent.vue.html').default },
    { path: '/chatAsTutor', component: require('./components/chatAsTutor/chatAsTutor.vue.html').default },
